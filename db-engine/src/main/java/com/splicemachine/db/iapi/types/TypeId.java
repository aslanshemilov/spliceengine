...
public class TypeId{
    ...
    */
    public static final TypeId BOOLEAN_ID=create(StoredFormatIds.BOOLEAN_TYPE_ID,StoredFormatIds.BOOLEAN_TYPE_ID_IMPL);

    public static final TypeId SMALLINT_ID=create(StoredFormatIds.SMALLINT_TYPE_ID,StoredFormatIds.SMALLINT_TYPE_ID_IMPL);

    public static final TypeId INTEGER_ID=create(StoredFormatIds.INT_TYPE_ID,StoredFormatIds.INT_TYPE_ID_IMPL);
    ...
    private static final TypeId BIT_ID=create(StoredFormatIds.BIT_TYPE_ID,StoredFormatIds.BIT_TYPE_ID_IMPL);
    private static final TypeId VARBIT_ID=create(StoredFormatIds.VARBIT_TYPE_ID,StoredFormatIds.VARBIT_TYPE_ID_IMPL);
    private static final TypeId REF_ID=create(StoredFormatIds.REF_TYPE_ID,StoredFormatIds.REF_TYPE_ID_IMPL);
    private static final TypeId LONGVARCHAR_ID=create(StoredFormatIds.LONGVARCHAR_TYPE_ID,
            StoredFormatIds.LONGVARCHAR_TYPE_ID_IMPL);
    private static final TypeId LONGVARBIT_ID=create(StoredFormatIds.LONGVARBIT_TYPE_ID,
    ...
    public static TypeId[] getAllBuiltinTypeIds(){
        ...
        System.arraycopy(ALL_BUILTIN_TYPE_IDS,0,retval,0,count);
    ...
    public static TypeId getUserDefinedTypeId(String schemaName,
                                              ...
                                              String className) throws StandardException{
        return new TypeId(StoredFormatIds.USERDEFINED_TYPE_ID_V3,
    ...
    public static TypeId getSQLTypeForJavaType(String javaTypeName)
        ...
        switch(javaTypeName){
            ...
            case "java.sql.Clob":
                return CLOB_ID;
            case "com.splicemachine.db.iapi.types.XML":
                return XML_ID;
            default:
                /*
    ...
    public boolean equals(Object that){
        return that instanceof TypeId && this.getSQLTypeName().equals(((TypeId)that).getSQLTypeName());
    }
    ...
    private void setTypeIdSpecificInstanceVariables(){
        switch(formatId){
            ...
            case StoredFormatIds.XML_TYPE_ID:
                ...
                javaTypeName="com.splicemachine.db.iapi.types.XML";
     ...
     */
    public StructField getStructField(String columnName, int precision, int scale) {
        ...
        switch (formatId) {
            ...
            default:
                //case StoredFormatIds.ARRAY_TYPE_ID:
                // SQLArray has an implementation for getStructField(), which tries to create an ArrayType if all
                // fields in the Array are of the same type.
                // This relies on a field "type" in SQLArray to be set. Currently, SQLArray.getStructField() is only called
                // for ExecRow which has Null values and it does not set the type field. So essentially we
                // never were able to create an ArrayType for native spark execution.
